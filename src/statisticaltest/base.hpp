...
public:
    ...
    virtual unsigned long long read(unsigned long long num,unsigned long long *id, shared_ptr<Matrix<TRACETYPE,BATCH_SIZE,Dynamic> >traces, shared_ptr<Matrix<DATATYPE,BATCH_SIZE,1> > knowndata) = 0;
